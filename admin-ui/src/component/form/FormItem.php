 ...
 * @method $this hasFeedback(bool $feedback = true) 配合 validateStatus 属性使用，展示校验状态图标，建议只配合 Input 组件使用    boolean
 ...
 * @method $this required(bool $required = true) 是否必填，如不设置，则会根据校验规则自动生成                                    boolean
 ...
 * @method $this validateFirst(bool $validateFirst = true) 当某一规则校验不通过时，是否停止剩下的规则的校验。                    boolean
