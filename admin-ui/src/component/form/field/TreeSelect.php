 ...
 * @method $this treeCheckStrictly(bool $strict = true) checkable 状态下节点选择完全受控（父子节点选中状态不再关联），会使得 labelInValue 强制为 true                                             boolean
 * @method $this treeData(mixed $data = []) treeNodes 数据，如果设置则不需要手动构造 TreeNode 节点（value 在整个树范围内唯一）
 * @method $this fieldNames(mixed $names = []) 替换 treeNode 中 title,value,key,children 字段为 treeData 中对应的字段              object
