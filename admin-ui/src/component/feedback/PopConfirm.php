 ...
 * @method $this arrowPointAtCenter(bool $arrowPointAtCenter = true) 箭头是否指向目标元素中心                             boolean
 ...
 * @method $this defaultVisible(bool $defaultVisible = true) 默认是否显隐                                        		boolean
 ...
 * @method $this destroyTooltipOnHide(bool $destroyTooltipOnHide = true) 隐藏后是否销毁 tooltip                          boolean
